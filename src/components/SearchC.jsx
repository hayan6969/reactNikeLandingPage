import {
  ...
  export function SearchC({image,title,info,price}) {
    return (
        
      
        <Card className="w-[350px] h-[400px] shadow-3xl overflow-hidden mb-5 px-5  max-lg:w-80 max-lg:h-81 flex justify-center items-center">
        ...
        <CardFooter className="pt-4 pb-3 flex justify-center items-center">
          ...
          <Button1 label={price} name={title} image={image} price={price}  iconURL={Cart} />
        </CardFooter>
      </Card>
